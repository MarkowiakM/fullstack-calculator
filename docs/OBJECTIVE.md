...
The original recruitment task this repository was built for, kept verbatim for reference.
...
- Spend ~2–4 hours on this assignment. Prioritize correctness, clarity, and
